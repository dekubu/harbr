# -*- encoding: utf-8 -*-
# stub: standard 1.32.0 ruby lib

Gem::Specification.new do |s|
  s.name = "standard".freeze
  s.version = "1.32.0".freeze
  ...
  s.add_runtime_dependency(%q<rubocop>.freeze, ["~> 1.57.2".freeze])
  s.add_runtime_dependency(%q<lint_roller>.freeze, ["~> 1.0".freeze])
  s.add_runtime_dependency(%q<standard-custom>.freeze, ["~> 1.0.0".freeze])
  s.add_runtime_dependency(%q<standard-performance>.freeze, ["~> 1.2".freeze])
