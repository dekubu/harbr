# -*- encoding: utf-8 -*-
# stub: rubocop-performance 1.19.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<rubocop>.freeze, [">= 1.7.0".freeze, "< 2.0".freeze])
  s.add_runtime_dependency(%q<rubocop-ast>.freeze, [">= 0.4.0".freeze])
end
